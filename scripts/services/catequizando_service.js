...
const FIND_BY_ETAPA_ID_AND_NAME_COMMUNITY_OR_PARISH_URL = `${BASE_URL_PROD}/api/catequizandos/v1/find-by/etapaIdAndCommunityOrParish?etapaId={etapaId}&communityOrParish={nameCommunityOrParish}`;
